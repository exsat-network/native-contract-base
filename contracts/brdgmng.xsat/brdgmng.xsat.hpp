...
class [[eosio::contract("brdgmng.xsat")]] brdgmng : public contract {
   public:
    ...
    void deposit(const name& actor, const uint64_t permission_id, const string& b_id, const string& wallet_code,
                 const string& btc_address, const string& order_id, const string& order_no, const uint64_t block_height,
                 const string& tx_id, const uint64_t amount, const optional<string>& remark_detail,
                 const uint64_t tx_time_stamp, const uint64_t create_time_stamp);

    [[eosio::action]]
    void valdeposit(const name& actor, const uint64_t permission_id, const uint64_t deposit_id, const uint8_t tx_status,
    ...
    void withdrawinfo(const name& actor, const uint64_t permission_id, const uint64_t withdraw_id, const string& b_id,
                      const string& wallet_code, const string& order_id, const uint64_t block_height,
                      const string& tx_id, const optional<string>& remark_detail, const uint64_t tx_time_stamp,
   ...
   private:
    ...
    struct [[eosio::table]] deposit_row {
        ...
        checksum160 by_order_no() const { return xsat::utils::hash_ripemd160(order_no); }
    ...
    typedef eosio::multi_index<
        ...
        eosio::indexed_by<"byorderno"_n, const_mem_fun<deposit_row, checksum160, &deposit_row::by_order_no>>,
    ...
    typedef eosio::multi_index<
        ...
        eosio::indexed_by<"byorderno"_n, const_mem_fun<withdraw_row, checksum160, &withdraw_row::by_order_no>>,
    ...
    bool verifyProviders(const std::vector<provider_actor_info>& requested_actors,
