...
class [[eosio::contract("exsat.xsat")]] exsat : public contract {
   public:
    ...
    using create_action = eosio::action_wrapper<"create"_n, &exsat::create>;
    using issue_action = eosio::action_wrapper<"issue"_n, &exsat::issue>;
    using retire_action = eosio::action_wrapper<"retire"_n, &exsat::retire>;
    using transfer_action = eosio::action_wrapper<"transfer"_n, &exsat::transfer>;
    using open_action = eosio::action_wrapper<"open"_n, &exsat::open>;
    using close_action = eosio::action_wrapper<"close"_n, &exsat::close>;
    using transferlog_action = eosio::action_wrapper<"transferlog"_n, &exsat::transferlog>;
