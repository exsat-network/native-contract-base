...
cdt-cpp ../../contracts/rwddist.xsat/rwddist.xsat.cpp -I ../../contracts/ 
...
cleos push action blkendt.xsat config '[0, 10, 15]' -p blkendt.xsat
cleos push action utxomng.xsat config '[600, 100, 5000, 100, 10, 10]' -p utxomng.xsat
